...
export default function PartnerDashboard() {
  ...
  return <div className="page-shell py-10 md:py-16 space-y-8">
    ...
    <header className="space-y-3"><p className="text-sm uppercase tracking-[0.18em] text-primary">{project.title}</p><h1 className="text-3xl md:text-4xl font-semibold">Partner Dashboard</h1><p className="max-w-2xl text-muted-foreground">Follow these two steps: sign the partnership agreement before mobility, then complete team reimbursement after mobility.</p></header>

...
```text
ebook.html?drive=GOOGLE_DRIVE_FILE_ID&large=1&sizeMb=345
```
...
```text
ebook.html?drive=1cwOC8g5UUEvrSmc2zo4HmHlJWT90QBpw&large=1&sizeMb=345
```
...
The `sizeMb=345` option gives the loading bar an estimated file size when Google Drive does not report the full download size to PDF.js.
